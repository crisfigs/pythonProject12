...
class Player(BasePlayer):
   ...
   ##Personal Experience/Memory
    ...
    family_shared_stories = models.StringField(
        label="1. ¿Ha compartido su familia historias sobre la Guerra Civil Española y la dictadura de Franco?",
        choices=[
    ...
    p1_responsible_nationals = models.BooleanField(label="El bando Nacional", blank=True,initial=False)
    p1_responsible_republicans = models.BooleanField(label="El bando Republicano", blank=True,initial=False)
    p1_responsible_doesntknow = models.BooleanField(label="No sé", blank=True,initial=False)
    p1_responsible_nothing = models.BooleanField(label="No aplica", blank=True,initial=False)
    p2_responsible_nationals = models.BooleanField(label="El bando Nacional", blank=True,initial=False)
    p2_responsible_republicans = models.BooleanField(label="El bando Republicano", blank=True,initial=False)
    p2_responsible_doesntknow = models.BooleanField(label="No sé", blank=True,initial=False)
    p2_responsible_nothing = models.BooleanField(label="No aplica", blank=True,initial=False)
    p3_responsible_nationals = models.BooleanField(label="El bando Nacional",blank=True, initial=False)
    p3_responsible_republicans = models.BooleanField(label="El bando Republicano", blank=True,initial=False)
    p3_responsible_doesntknow = models.BooleanField(label="No sé", blank=True,initial=False)
    p3_responsible_nothing = models.BooleanField(label="No aplica", blank=True,initial=False)

    #Family Memory Alignment
    family_memory_alignment = models.FloatField(
    ...
    belief_white_red_terror = models.IntegerField(label="Un estudio de investigadores de la Universidad de California estima que unas 150.000 personas fueron asesinadas por nacionalistas durante el Terror Blanco, y hasta 50.000 por republicanos durante el Terror Rojo.",
                                                  min=0, max=100)
    belief_franco_growth = models.IntegerField(label="Según un portal especializado en economía, el régimen de Franco tuvo el mayor crecimiento económico en la historia reciente de España.",
                                               min=0, max=100)
    ...
    learned_something = models.IntegerField(
        label='6. Indique hasta qué punto está usted de acuerdo o en desacuerdo con la siguiente afirmación: "He aprendido algo nuevo del texto que acabo de leer."',
        choices=[
    ...
    transmission_family = models.IntegerField(label='La familia o parientes: ',
                                              choices=[[0, 'Nada'],
                                                       ...
                                                       [3, 'Bastante'],
                                                       [4, 'Muy']], widget=widgets.RadioSelectHorizontal)
    transmission_media = models.IntegerField(label='Los medios de comunicación tradicionales (libros, películas, prensa, etc.): ',
                                             choices=[[0, 'Nada'],
                                                      [1, 'Poco'],
                                                      [2, 'Algo'],
                                                      [3, 'Bastante'],
    ...
    follow_political_news = models.IntegerField(
        label="4. ¿Sigue usted las noticias políticas o los acontecimientos actuales?",
        choices=[[0, 'Nada'],
                 [1, 'Poco'],
                 [2, 'Algo'],
                 [3, 'Bastante'],
    ...
    political_participation_current = models.IntegerField(
        label="5. ¿Participa usted en acciones políticas (por ejemplo, protestas, firmas de peticiones o campañas)?",
        choices=[[0, 'Nada'],
                 [1, 'Poco'],
                 [2, 'Algo'],
                 [3, 'Bastante'],
...
class Memoria(Page): #"transmission_binary","transmission_no"
    ...
    form_fields = ["family_shared_stories",
                   ...
                   'p3_leftspain', 'p3_hiding', 'p3_lostjob', 'p3_another', 'p3_nothing',
